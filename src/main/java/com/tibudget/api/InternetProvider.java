...
public interface InternetProvider {
     ...
     * @return The response including body, headers
     ...
     */
    Response post(String url, String body, String contentType, Map<String, String> headers) throws IOException;
     ...
     * @return The response including body (the full path where the file has been stored), headers
     * @throws IOException on failure (invalid destination, network error, etc.)
     */
    Response downloadFile(String url, Map<String, String> headers, String forceContentType) throws IOException;

    /**
     * Represents an HTTP response including body, headers
     */
    class Response implements Serializable {
        ...
        public Response(int code, String message, String method, String location, String protocol, String body, Map<String, String> headers) {
            this.code = code;
