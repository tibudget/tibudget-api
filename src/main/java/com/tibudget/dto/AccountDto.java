...
public class AccountDto implements Serializable {
    ...
    public static final String METADATA_LOYALTY_CARD_BAR_CODE_TYPE = "LOYALTY_CARD_BAR_CODE_TYPE";
    /** Barcode value (card number, QR code content, etc.). */
    public static final String METADATA_LOYALTY_CARD_REFERENCE = "LOYALTY_CARD_REFERENCE";
    /** URL of the image of the loyalty card. */
    public static final String METADATA_LOYALTY_CARD_IMAGE = "LOYALTY_CARD_IMAGE";
