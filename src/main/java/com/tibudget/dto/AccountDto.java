...
public class AccountDto implements Serializable {
    ...
    public enum AccountDtoType {
        ...
        /**
         * Accounts that represents a loyalty card. It can be used for payments. These accounts will be checked when
         * linking transactions of type {@link TransactionDto.TransactionDtoType#PURCHASE}.
         * It must contains mandatory metadata {@link #METADATA_LOYALTY_CARD_BAR_CODE_TYPE},
         * {@link #METADATA_LOYALTY_CARD_REFERENCE}, {@link #METADATA_LOYALTY_CARD_BG_COLOR}
         * and {@link #METADATA_LOYALTY_CARD_LOGO}.
         */
        LOYALTY_CARD,
    ...
    /**
     * Common metadata keys : a stable identifier known by the collector (iban or loyalty card number for exemple)
     */
     ...
     */
    public static final String METADATA_IBAN = "tibu:iban";

    /**
     * Type of barcode, one of BarcodeTypeEnum
     */
    public static final String METADATA_LOYALTY_CARD_BAR_CODE_TYPE = "tibu:loyalty_card_barcode_type";
    /**
     * Barcode value (card number, QR code content, etc.).
     */
    public static final String METADATA_LOYALTY_CARD_REFERENCE = "tibu:loyalty_card_reference";
    /**
     * Color of the background of the loyalty card.
     */
    public static final String METADATA_LOYALTY_CARD_BG_COLOR = "tibu:loyalty_card_bg_color";
    /**
     * URL of the logo of the loyalty card. We recommend using an image with transparent background and to set the
     * background color with {@link #METADATA_LOYALTY_CARD_BG_COLOR}.
     */
    public static final String METADATA_LOYALTY_CARD_LOGO = "tibu:loyalty_card_logo";
